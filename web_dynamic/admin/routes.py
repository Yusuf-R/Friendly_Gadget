...
@admin_bp.route('/brands', strict_slashes=False)
def brands():
...
@admin_bp.route('/add_brand', methods=['POST', 'GET'], strict_slashes=False)
def add_brand():
...
@admin_bp.route('/edit_brand/<brand_id>', strict_slashes=False)
...
@admin_bp.route('/update_brand/<brand_id>', methods=['POST'], strict_slashes=False)
...
@admin_bp.route('/delete_brand/<brand_id>', methods=['GET'], strict_slashes=False)
...
@admin_bp.route('/create_model', methods=['POST'], strict_slashes=False)
def create_model():
...
@admin_bp.route('/edit_model/<model_id>', strict_slashes=False)
...
@admin_bp.route('/update_model/<model_id>', methods=['POST'], strict_slashes=False)
...
@admin_bp.route('/delete_model/<model_id>', methods=['GET'], strict_slashes=False)
...
@admin_bp.route('/summaries', strict_slashes=False)
def summaries():
    """Render the Summary page."""
    obj = storage.all(Model).values()
    return render_template('summaries.html', obj=obj)

@admin_bp.route('/view_summary/<model_id>', methods=['GET'], strict_slashes=False)
...
@admin_bp.route('/add_summary/<model_id>', methods=['GET'], strict_slashes=False)
...
@admin_bp.route('/create_summary/<model_id>', methods=['POST'], strict_slashes=False)
...
@admin_bp.route('/edit_summary/<model_id>', strict_slashes=False)
...
@admin_bp.route('/update_summary/<model_id>', methods=['POST'], strict_slashes=False)
